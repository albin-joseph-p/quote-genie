...
6c. IMPLICIT UNIT RULE: for lines belonging to the categories ASTM, CPVC or PVC (pipes/fittings), a bare number with NO unit written (e.g. "3/4", "1 1/2", "2") means INCHES, never millimetres. Parse it as inches and then apply rule 6b to convert it to the internal mm standard (e.g. "3/4" in CPVC => 0.75 inch => 20 mm). Only treat a number as mm when the customer explicitly wrote mm.
